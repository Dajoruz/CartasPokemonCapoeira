...
function init() {
	...
	labels["logo"] = new Label({x: 0.5, y: 0.3}, "KARPOEIRA", 192, true, false, false, "ChineseTakeaway");
	labels["play"] = new Label({x: 0.5, y: 0.7}, "DALE MI PANA!", 144, true, true, false, labelFont, enterQueue);
	labels["searching"] = new Label({x: 0.5, y: 0.7}, "BUSCANDO RIVAL   ", 144, false, false, false, labelFont);
	labels["result"] = new Label({x: 0.5, y: 0.3}, "", 192, false, false, false, labelFont);
	labels["rematch"] = new Label({x: 0.5, y: 0.62}, "DESAFIAR DENUEVO", 128, false, false, false, labelFont, requestRematch);
...
var typeColors = ["#FF2323", "#2394FF", "#09D525"];
var types = ["Fuego", "Agua", "Planta"];
var colors = {"yellow": "#DAF7A6", "orange": "#FFC300", "green": "#52a546", "blue": "#C70039", "red": "#581845", "purple": "#581845"};
